...
void launcher_notify_workarea_size()
{
    ...
    json_object_object_add(workarea_info, "x", json_object_new_int(launcher.x));
    json_object_object_add(workarea_info, "y", json_object_new_int(launcher.y));
    json_object_object_add(workarea_info, "width", json_object_new_int(launcher.width));
    json_object_object_add(workarea_info, "height", json_object_new_int(launcher.height));
